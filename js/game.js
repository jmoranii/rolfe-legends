...
const CREDIT_LINES = [
  { t: 15.56, w: [["Out", 15.56], ["in", 15.88], ["Rolfe", 16.0], ["where", 16.31], ["the", 16.49], ["cornfields", 16.68], ["grow", 17.33]] },
  { t: 18.21, w: [["Nine", 18.21], ["legends", 18.6], ["ruled", 19.23], ["the", 19.55], ["road", 19.81]] },
  { t: 21.14, w: [["Rusty", 21.14], ["barked,", 21.66], ["the", 22.18], ["ducks", 22.3], ["went", 22.68], ["quack", 23.02]] },
  { t: 23.54, w: [["Aaron's", 23.54], ["tornado", 24.12], ["got", 24.76], ["sent", 25.05], ["right", 25.36], ["back", 25.71]] },
  ...
  { t: 64.27, w: [["You", 64.27], ["played", 64.44], ["your", 64.77], ["cards", 65.04], ["and", 65.51], ["left", 65.74], ["your", 66.02], ["mark", 66.18]] },
  { t: 66.33, w: [["WYATT!", 66.33], ["The 10", 66.78], ["th", 66.94], ["Legend", 69.15], ["of", 69.53], ["Rolfe!", 69.69]] },
  { t: 70.4, w: [["Happy", 70.4], ["birthday,", 70.7], ["brave", 71.62], ["and", 71.99], ["bold", 72.39]] },
  { t: 73.27, w: [["Ten", 73.27], ["candles", 73.54], ["and", 73.94], ["a", 74.2], ["crown", 74.3], ["of", 74.96], ["gold", 75.58]] },
  { t: 78.11, w: [["WYATT!", 78.11], ["This", 79.12], ["song's", 79.35], ["for", 79.71], ["you —", 79.97]] },
  { t: 80.51, w: [["From", 80.51], ["Uncle", 80.78], ["James:", 81.22], ["I'm", 82.34], ["proud", 82.68], ["of", 83.14], ["you!", 83.32]] },
  { t: 88.22, w: [["The 10", 88.22], ["th", 88.56], ["Legend", 88.96], ["of", 89.48], ["Rolfe...", 89.72], ["that's", 90.6], ["you", 91.05]] },
];
const CREDIT_BEATS = [
  { t: 0,     kind: 'title' },
  { t: 15.56, kind: 'road' },
  { t: 21.14, kind: 'boss', id: 'rusty',   name: 'Rusty',          title: 'The Goodest Boy' },
  { t: 23.54, kind: 'boss', id: 'aaron',   name: 'Aaron',          title: 'The Lil Tornado' },
  { t: 26.38, kind: 'boss', id: 'jacob',   name: 'Dad',            title: 'The Wall' },
...
function creditsRoll(onDone) {
  ...
  function loop() {
    ...
    if (!continued && (t >= 96 || (audioEl() && audioEl().ended))) { beatIdx = CREDIT_BEATS.length - 1; showScene(CREDIT_BEATS[beatIdx]); }
